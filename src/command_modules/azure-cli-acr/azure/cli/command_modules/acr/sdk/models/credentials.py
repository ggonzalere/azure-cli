...
class Credentials(Model):
    ...
    :type source_registry:
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.SourceRegistryCredentials
    ...
    :type custom_registries: dict[str,
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.CustomRegistryCredentials]
    """
    ...
    def __init__(self, source_registry=None, custom_registries=None):
