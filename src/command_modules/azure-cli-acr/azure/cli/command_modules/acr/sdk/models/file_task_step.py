...
class FileTaskStep(TaskStepProperties):
    ...
    def __init__(self, task_file_path, context_path=None, context_access_token=None, values_file_path=None, values=None):
        super(FileTaskStep, self).__init__(context_path=context_path, context_access_token=context_access_token)
