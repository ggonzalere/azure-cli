...
class RunFilter(Model):
    ...
    def __init__(self, run_id=None, run_type=None, status=None, create_time=None, finish_time=None, output_image_manifests=None, is_archive_enabled=None, task_name=None):
