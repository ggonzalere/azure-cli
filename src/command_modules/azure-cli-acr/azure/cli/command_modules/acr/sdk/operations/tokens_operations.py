...
class TokensOperations(object):
    ...
    def create(
        ...
        :param bool raw: returns the direct response alongside the
         deserialized response
        :return: An instance of AzureOperationPoller that returns Token or
         ClientRawResponse if raw=true
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.containerregistry.v2019_05_01_preview.models.Token]
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.TokenPaged[~azure.mgmt.containerregistry.v2019_05_01_preview.models.Token]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
