...
class EncodedTaskStep(TaskStepProperties):
    ...
    def __init__(self, encoded_task_content, context_path=None, context_access_token=None, encoded_values_content=None, values=None):
        super(EncodedTaskStep, self).__init__(context_path=context_path, context_access_token=context_access_token)
