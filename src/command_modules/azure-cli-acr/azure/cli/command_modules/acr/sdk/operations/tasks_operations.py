...
class TasksOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.TaskPaged[~azure.mgmt.containerregistry.v2019_05_01_preview.models.Task]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2019_05_01_preview.models.Task
    ...
    def create(
        ...
        :type task_create_parameters:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.Task
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.containerregistry.v2019_05_01_preview.models.Task]
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def update(
        ...
        :type task_update_parameters:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.TaskUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :return: An instance of AzureOperationPoller that returns Task or
