...
class TaskUpdateParameters(Model):
    ...
    :param status: The current status of task. Possible values include:
     'Disabled', 'Enabled'
    :type status: str or
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.TaskStatus
    :param platform: The platform properties against which the run has to
     happen.
    :type platform:
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.PlatformUpdateParameters
    ...
    :type step:
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.TaskStepUpdateParameters
    :param trigger: The properties for updating trigger properties.
    :type trigger:
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.TriggerUpdateParameters
    ...
    def __init__(self, status=None, platform=None, agent_configuration=None, timeout=None, step=None, trigger=None, credentials=None, tags=None):
