...
class DockerBuildStep(TaskStepProperties):
    ...
    def __init__(self, docker_file_path, context_path=None, context_access_token=None, image_names=None, is_push_enabled=True, no_cache=False, target=None, arguments=None):
        super(DockerBuildStep, self).__init__(context_path=context_path, context_access_token=context_access_token)
