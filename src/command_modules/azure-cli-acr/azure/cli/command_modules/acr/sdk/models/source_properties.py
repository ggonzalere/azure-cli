...
class SourceProperties(Model):
    ...
    :type source_control_type: str or
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.SourceControlType
    ...
    :type source_control_auth_properties:
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.AuthInfo
    """
    ...
    def __init__(self, source_control_type, repository_url, branch=None, source_control_auth_properties=None):
        super(SourceProperties, self).__init__()
