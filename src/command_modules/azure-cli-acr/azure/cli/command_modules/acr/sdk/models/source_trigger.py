...
class SourceTrigger(Model):
    ...
    :type source_repository:
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.SourceProperties
    :param source_trigger_events: The source event corresponding to the
     trigger.
    :type source_trigger_events: list[str or
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.SourceTriggerEvent]
    ...
    def __init__(self, source_repository, source_trigger_events, name, status=None):
