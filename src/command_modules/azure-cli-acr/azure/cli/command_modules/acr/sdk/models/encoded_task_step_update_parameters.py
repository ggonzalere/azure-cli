...
class EncodedTaskStepUpdateParameters(TaskStepUpdateParameters):
    ...
    def __init__(self, context_path=None, context_access_token=None, encoded_task_content=None, encoded_values_content=None, values=None):
        super(EncodedTaskStepUpdateParameters, self).__init__(context_path=context_path, context_access_token=context_access_token)
