...
class RegistriesOperations(object):
    ...
    def import_image(
        ...
        :type parameters:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.ImportImageParameters
    ...
    def check_name_availability(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.RegistryNameStatus
    ...
    def get(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.Registry or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-10-01"
    ...
    def create(
        ...
        :type registry:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.Registry
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :return: An instance of AzureOperationPoller that returns Registry or
         ClientRawResponse if raw=true
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.containerregistry.v2019_05_01_preview.models.Registry]
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def update(
        ...
        :type registry_update_parameters:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.RegistryUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :return: An instance of AzureOperationPoller that returns Registry or
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.RegistryPaged[~azure.mgmt.containerregistry.v2019_05_01_preview.models.Registry]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-10-01"
    ...
    def list_credentials(
        ...
        :return: RegistryListCredentialsResult or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.RegistryListCredentialsResult
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-10-01"
    ...
    def list_usages(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.RegistryUsageListResult
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-10-01"
    ...
    def list_policies(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.RegistryPolicies
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-10-01"
    ...
    def update_policies(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.containerregistry.v2019_05_01_preview.models.RegistryPolicies]
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def schedule_run(
        ...
        :type run_request:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.RunRequest
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :return: An instance of AzureOperationPoller that returns Run or
         ClientRawResponse if raw=true
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.containerregistry.v2019_05_01_preview.models.Run]
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def get_build_source_upload_url(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2019_05_01_preview.models.SourceUploadDefinition
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2018-09-01"
    ...
    def _generate_keys_initial(
        ...
        # Construct URL
        url = self.generate_keys.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', min_length=1),
            'registryName': self._serialize.url("registry_name", registry_name, 'str', max_length=50, min_length=5, pattern=r'^[a-zA-Z0-9]*$')
    ...
    def generate_keys(
        ...
        :param bool raw: returns the direct response alongside the
         deserialized response
        :return: An instance of AzureOperationPoller that returns
         GenerateCredentialsResult or ClientRawResponse if raw=true
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.containerregistry.v2019_05_01_preview.models.GenerateCredentialsResult]
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        raw_result = self._generate_keys_initial(
            resource_group_name=resource_group_name,
            registry_name=registry_name,
        ...
        return AzureOperationPoller(
            long_running_send, get_long_running_output,
            get_long_running_status, long_running_operation_timeout)
    generate_keys.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/generateCredentials'}
