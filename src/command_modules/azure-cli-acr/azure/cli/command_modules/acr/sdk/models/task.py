...
class Task(Resource):
    ...
    :type step:
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.TaskStepProperties
    :param trigger: The properties that describe all triggers for the task.
    :type trigger:
     ~azure.mgmt.containerregistry.v2019_05_01_preview.models.TriggerProperties
    ...
    def __init__(self, location, platform, step, tags=None, status=None, agent_configuration=None, timeout=3600, trigger=None, credentials=None):
        super(Task, self).__init__(location=location, tags=tags)
